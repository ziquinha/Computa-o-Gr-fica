...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/e11.vert", "shaders/e11.frag"),
			new CGFshader(this.gl, "shaders/e12.vert", "shaders/texture3anim.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/e13.frag"),
	...
	update(t) {
		...
		if (this.selectedExampleShader == 6)
			...
			this.testShaders[12].setUniformsValues({ timeFactor: t / 1000 % 1000 });
	}
